...
| 11 | The Threefold Promise | 2 | M | ✅ done. Waldron's organizing spine: Nation / Land / Spiritual traced across the OT. Two threads tied off at the conquest (Josh 21:43–45), the spiritual thread tied off in Christ (Gal 3:16). Added 2026-05-29 from a review of Waldron's booklets. Danger spot handled: Land thread vs. modern-Israel claims — held to Josh 21:45's own verdict, exile = Deut 28 discipline, no restorationist reading. |
| 12 | The Preserved Line | 2 | M | ✅ done. Waldron's royal-line through-line: God guarded David's line to the Messiah through three near-extinctions (Arabian raid 2 Chr 21:17, Athaliah's purge 2 Ki 11, Jehoiachin in exile 2 Ki 25:27–30). Added 2026-05-29 from the Waldron review. Danger spot handled: the Jeconiah curse (Jer 22:30) vs. Matt 1:12 genealogy — presented as a real question with the text's own resolution, not dogmatized; two-genealogy view noted without insisting. |
| 13 | Why Babel? | 2 | M-L | ✅ done. The why behind Gen 11, not the what. Both sides' stated motives, five Hebrew word studies (shem, batsar, zamam, balal, puts), the careful exegetical case for the Reading-B interpretation of Gen 11:6 (danger is bent-unified-unchecked capability, NOT capability per se), four cross-references (creation mandate, Acts 17:26–27, Deut 32:8, Gen 10, Pentecost/Rev 7 as resonance, the pride dimension). Built 2026-05-29 because Paul wanted the full study for a book he's writing whose amplitude argument depends on Reading B. Danger spots handled: Pentecost-reverses-Babel flagged as resonance not proof-text; Deut 32:8 textual variant flagged honestly. |
| 14 | The Stones Cry Out | 2 | M | ✅ done (2026-06-09). Archaeological-confirmation companion to The Prophecies: where prophecy shows Scripture foretold, this shows Scripture's people and places were real. Seven finds across three filters — People & Kings (Hittites/Hattusa, House of David/Tel Dan Stele, Hezekiah's bulla, Cyrus Cylinder), Roads & Places (Way of the Sea / Solomonic gates, King's Highway / Edom & Moab), The Text Itself (Great Isaiah Scroll). First spoke to carry photographs — six CC/PD-licensed artifact images from Wikimedia Commons, full attribution in the About panel + inline credits. Occasioned by Charles's "I Am Convinced" lesson (New Caney church of Christ, June 2026). Wired into 5 timeline cards (Machpelah/Hittites, Davidic covenant, Hezekiah, Isaiah, Cyrus's decree). Berean cautions stated plainly in-page: archaeology proves reliability not inspiration; Cyrus Cylinder doesn't name the Jews; Solomonic-gate dating debated; skeptic positions summarized not quoted (no fabricated verbatim). NASB quotes verified via Bolls. anchor Joshua 24:27. |
| — | Considered & rejected from Waldron review (2026-05-29) | — | — | Life of Christ 7-part (NT, out of scope); Patriarchs split (folded into Threefold Promise); Joseph-as-type (NT never names it — BEREAN_BRIEF violation); 3-cycle memory quiz (different genre, a feature not a spoke); conquest-campaign maps (better as a Maps feature). Deliberately NOT built — would be busy work. |
