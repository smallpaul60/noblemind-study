#!/usr/bin/env python3
"""Generate EPUB for One Day Closer to Home."""
...
BOOK_ID = "one-day-closer-to-home-2026"
TITLE = "One Day Closer to Home"
SUBTITLE = "What the Bible Says About Growing Old, Dying Well, and the Life to Come"
AUTHORS = ["Paul Hainline"]
PUBLISHER = "NobleMind Press"
YEAR = "2026"
LANGUAGE = "en"
DESCRIPTION = (
    "A 13-chapter study on aging, death, and eternity rooted in Scripture \u2014 "
    "from the examples of Simeon, Anna, and Caleb through the theology of "
    "resurrection and the hope of what lies ahead."
)

CHAPTERS = [
    ("chapter-01.html", "Chapter 1", "The Rearview Mirror", "Part I: The Examples"),
    ("chapter-02.html", "Chapter 2", "Simeon\u2019s Eyes", None),
    ("chapter-03.html", "Chapter 3", "Anna Never Left", None),
    ("chapter-04.html", "Chapter 4", "Give Me This Mountain", None),
    ("chapter-05.html", "Chapter 5", "Outwardly Wasting, Inwardly New", "Part II: The Theology"),
    ("chapter-06.html", "Chapter 6", "The Tent and the Building", None),
    ("chapter-07.html", "Chapter 7", "Sown Perishable, Raised Imperishable", None),
    ("chapter-08.html", "Chapter 8", "Abraham\u2019s City", None),
    ("chapter-09.html", "Chapter 9", "Free from the Fear of Death", None),
    ("chapter-10.html", "Chapter 10", "A Momentary Light Affliction", "Part III: The Crescendo"),
    ("chapter-11.html", "Chapter 11", "No More Tears", None),
    ("chapter-12.html", "Chapter 12", "Why Are You Still Waiting?", None),
    ("chapter-13.html", "Chapter 13", "Press On", None),
]
...
def main():
    print("Generating EPUB for One Day Closer to Home...")
    book = epub.EpubBook()
...
<div class="copyright-page">
  ...
  Used by permission.</p>
    ...
    current_part_num = 0
    part_names = {
        "Part I: The Examples": ("Part I", "The Examples"),
        "Part II: The Theology": ("Part II", "The Theology"),
        "Part III: The Crescendo": ("Part III", "The Crescendo"),
    }
    ...
    output = BOOK_DIR / "One_Day_Closer_to_Home.epub"
