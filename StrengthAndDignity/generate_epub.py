#!/usr/bin/env python3
"""Generate EPUB for Your Name Means Everything: Strength and Dignity.
...
# --- Book metadata ---
BOOK_ID = "your-name-means-everything-strength-and-dignity-2026"
TITLE = "Your Name Means Everything: Strength and Dignity"
SUBTITLE = "What the Bible Says to Young Women About Character, Wisdom, and Faith"
...
CHAPTERS = [
    ...
    ("chapter-02.html", "Chapter 2", "The Woman in the Mirror Isn\u2019t the Whole Story", None),
...
def main():
    print("Generating EPUB for Your Name Means Everything: Strength and Dignity...")
...
<div class="title-page">
  ...
  <p class="subtitle">Strength and Dignity</p>
...
<div class="copyright-page">
  <p><strong>Your Name Means Everything: Strength and Dignity</strong></p>
  <p>{SUBTITLE}</p>
...
<div class="part-divider">
  ...
  <p class="part-title">{part_title_str}</p>
    ...
    # Write EPUB
    output = BOOK_DIR / "Strength_and_Dignity.epub"
