#!/usr/bin/env python3
"""Generate EPUB for The God Who Showed Up."""
...
BOOK_ID = "the-god-who-showed-up-2026"
TITLE = "The God Who Showed Up"
...
LANGUAGE = "en"
DESCRIPTION = (
    "God did not reveal all His names at once. He revealed each one at a "
    "specific moment \u2014 when His people needed to know that particular "
    "truth about who He is. From Elohim in Genesis 1 to Immanuel in Matthew 1, "
    "this book follows the names of God in the order He revealed them."
)

CHAPTERS = [
    ("introduction.html", "Introduction", "What\u2019s In A Name?", None),
    ("chapter-01.html", "Chapter 1", "Elohim \u2014 The God Who Was Already There", "Part I: The God Who Hears"),
    ("chapter-02.html", "Chapter 2", "El Roi \u2014 The God Who Sees", None),
    ("chapter-03.html", "Chapter 3", "El Shaddai \u2014 God Almighty", None),
    ("chapter-04.html", "Chapter 4", "Jehovah Jireh \u2014 The Lord Will Provide", "Part II: When the Veil Still Stood"),
    ("chapter-05.html", "Chapter 5", "Yahweh \u2014 The Self-Existent One", None),
    ("chapter-06.html", "Chapter 6", "Jehovah Rapha \u2014 The Lord Who Heals", "Part III: The Veil Is Torn"),
    ("chapter-07.html", "Chapter 7", "Jehovah Nissi \u2014 The Lord Is My Banner", None),
    ("chapter-08.html", "Chapter 8", "Jehovah Shalom \u2014 The Lord Is Peace", "Part IV: Through the Open Door"),
    ("chapter-09.html", "Chapter 9", "Jehovah Rohi \u2014 The Lord Is My Shepherd", None),
    ("chapter-10.html", "Chapter 10", "Jehovah Tsidkenu \u2014 The Lord Our Righteousness", "Part V: The Life of Prayer"),
    ("chapter-11.html", "Chapter 11", "Jehovah Shammah \u2014 The Lord Is There", None),
    ("chapter-12.html", "Chapter 12", "Immanuel \u2014 God With Us", None),
    ("conclusion.html", "Conclusion", "He Is Still Showing Up", None),
]
...
.chapter-body blockquote cite { display: block; margin-top: 0.5em; font-style: normal; font-weight: bold; font-size: 0.9em; }
...
def main():
    print("Generating EPUB for The God Who Showed Up...")
    book = epub.EpubBook()
...
<div class="copyright-page">
  ...
  Used by permission.</p>
    ...
    output = BOOK_DIR / "The_God_Who_Showed_Up.epub"
