...
## Front Matter — Inscription and Dedication (Class Edition)

*Layout note: these two pages face each other in print. The Inscription is on the verso (left, even-numbered page); the Dedication is on the recto (right, odd-numbered page) directly across from it. Both pages appear after the title page and copyright page, before the table of contents and preface. The inscription is filled in by hand by the giver(s) at the time the book is presented.*

*This is the class edition of the dedication, written for students receiving the book through their congregation's Bible class. The general edition is the default; this one is used only when the book is being printed as a gift for students working through 1 Corinthians 13 in a class setting.*

---

### Inscription Page *(facing page, verso)*
