#!/usr/bin/env python3
"""Generate The Character No One Could Invent PDF from HTML chapter files."""
...
OUTPUT = BOOK_DIR / "The_Character_No_One_Could_Invent.pdf"
...
def build_toc():
    ...
    current_part = None
    for filename in CHAPTERS[1:]:  # skip foreword
...
<body>
  ...
  <div class="title-page">
    ...
    <p class="subtitle-line">The Evidence of Jesus' Deity</p>
