#!/usr/bin/env python3
"""Generate Lulu linen-hardcover DUST JACKET for "A Good Name".

Lulu specs (pulled from Lulu's downloaded hardcover jacket template
for this title):
  Document size:    19.5" x 9.25"   (495.3mm x 234.95mm)
...
Layout (left to right):
  ...
  Total: 3.25 + 0.25 + 5.875 + 0.75 + 5.875 + 0.25 + 3.25 = 19.5"

Design mirrors the AGN paperback covers (deep navy background, warm
gold typography, "YOUR / NAME / MEANS / EVERYTHING" hero) for visual
consistency between the paperback and hardcover editions. Differences
from the SaD jacket are book-specific copy and palette only — the
panel geometry, visual-centering shifts, and About-the-Authors back
flap structure are identical.

Hardcover ISBN: 979-8-9954288-1-7.
"""
...
OUTPUT = BOOK_DIR / "YourNameMeansEverything_Lulu_Hardcover_Jacket.pdf"
...
def main():
    print('Generating Lulu HARDCOVER JACKET PDF for "A Good Name"...')
